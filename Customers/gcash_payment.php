  ...
  if (logoutConfirmed) {
    ...
    window.location.href = "logout.php";
        ...
        <div id="page-wrapper">
         ...
         <center><h3 style="color:black;"> <span class="fa fa-cart-plus"></span> Online Payment</h3></center>
        </div>
...
if ($stmt->rowCount() > 0) {
    ...
    <h4>Reference No(For Gcash Payment)</h4>
    <label class="control-label">Payment</label>
    <input style="width: auto;" class="form-control" type="text" name="order_payment" oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 13)" maxlength="13" required title="Enter Gcash Reference No." required />
    ...
    <?php
		...
		extract($edit_row);
        echo "<br>";
        echo "<a class='btn btn-block btn-success' href='?update_id=" . $user_id . "'><span class='glyphicon glyphicon-shopping-cart'></span> Order</a>";
    }
    ?>
